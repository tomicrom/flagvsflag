...
<div class="five columns izq" id="flag1">
    ...
    <a href="#" onclick="javscript:voteFlag(<?php echo $data_flag2['id']; ?>)"><img src="images/flags/<?php echo $data_flag1['file']; ?>"></a>
</div>
...
<div class="five columns der" id="flag2">
    ...
    <a href="#" onclick="javscript:voteFlag(<?php echo $data_flag2['id']; ?>)" id="<?php echo $data_flag2['id']; ?>"><img src="images/flags/<?php echo $data_flag2['file']; ?>"></a>
</div>