...
<div class="five columns izq" id="flag1">
    ...
    <a href="javascript:void(0);" onclick="javscript:voteFlag(<?php echo $data_flag1['id']; ?>)"><img src="images/flags/<?php echo $data_flag1['file']; ?>" border="1"></a>
</div>
...
<div class="five columns der" id="flag2">
    ...
    <a href="javascript:void(0);" onclick="javscript:voteFlag(<?php echo $data_flag2['id']; ?>)"><img src="images/flags/<?php echo $data_flag2['file']; ?>" border="1"></a>
</div>